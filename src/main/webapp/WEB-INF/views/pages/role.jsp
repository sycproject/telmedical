...
<div class="row">
	<div class="col-xs-12">
		<div class="table-header">
			<i class="menu-icon fa fa-file-o bigger-120"></i>&nbsp;&nbsp; 角色列表
   ...
   //put inline scripts related to this page here
	  ...
	  oTable =  $('#myTable').dataTable( {
	       ...
	       "aoColumns": [      
	            ...
	            { "data": "rolekey", "sName": "roleKey","sClass": "center"},
	           	{ "data":"description","sName": "descriptions","bSortable": false,"sClass": "center"},
	           	{ "data":"status","sName": "status","bSortable": false,"sClass": "center"},
	        ...
	        "createdRow": function ( row, data, index ) {
	        	...
	        	if(status == 1){
	        		...
	        		status = '<span class="label label-sm label-error">禁用</span>';
	        	}
	        	$('td',row).eq(3).addClass("hidden-480 center").html(status);
